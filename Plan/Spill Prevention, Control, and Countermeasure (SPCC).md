...
## SECTION 7.0: INSPECTIONS AND MONITORING
...
**Form B: Monthly Piping/Valve Inspection**
...
Inspection records will be maintained for at least 3 years and include:
...
## SECTION 9.0: PERSONNEL TRAINING [40 CFR 112.7(f)]

### 9.1 Training Requirements

All oil-handling personnel shall receive training on:
...
- ☐ Location and use of spill response equipment
...
Annual briefings will be conducted for all oil-handling personnel to discuss:

- ☐ Known discharges or failures at this or similar facilities
- ☐ Malfunctioning components and corrective actions
- ☐ Recently developed precautionary measures
- ☐ Changes to this SPCC Plan
- ☐ Lessons learned from drills or actual spills
- ☐ New equipment or procedures
- ☐ Regulatory updates

### 9.4 Drills and Exercises
...
Training records will be maintained for at least 3 years and include:

- Date of training
- Names of attendees
- Topics covered
- Instructor name and qualifications
- Results of any testing/evaluation
- Sign-in sheets

**Training Log:**

| **Date** | **Topic** | **Instructor** | **Attendees** | **Documentation** |
|----------|-----------|----------------|---------------|-------------------|
| | | | | |
| | | | | |
| | | | | |
...
## SECTION 10.0: SPILL RESPONSE PROCEDURES

### 10.1 Immediate Actions

**If a spill is discovered:**
...
- Initiate emergency contacts list
...
### 10.2 Spill Response Equipment Inventory
...
## SECTION 12.0: PLAN REVIEW AND AMENDMENT [40 CFR 112.5]

### 12.1 Five-Year Review

This Plan will be reviewed at least once every five years from the certification date.
...
| **Review Date** | **Reviewer** | **Findings** | **Changes Made** |
|-----------------|--------------|--------------|------------------|
| | | | |
| | | | |

### 12.2 Amendment Triggers

This Plan will be amended within six months if:

- ☐ A spill larger than 1,000 gallons occurs
- ☐ Two or more spills of more than 42 gallons occur within any 12-month period
- ☐ There is a change in facility design, construction, operation, or maintenance that materially affects potential for discharge
- ☐ More effective prevention technology becomes field-proven and practicable
- ☐ There is a change in applicable regulations
- ☐ Ownership of facility changes
- ☐ A new tank is installed
- ☐ A tank is removed or decommissioned

### 12.3 Amendment Log

| **Amendment #** | **Date** | **Description of Change** | **Approved By** | **Sections Affected** |
|-----------------|----------|---------------------------|-----------------|------------------------|
| 1 | | | | |
| 2 | | | | |
| 3 | | | | |
...
I certify that this SPCC Plan meets the applicable requirements of 40 CFR 112 and will be fully implemented upon certification.

---

**For Tier I or Tier II Qualified Facilities (Self-Certification):**
