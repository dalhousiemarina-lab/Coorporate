...
The current 2026 framework fills every one of those gaps. We have now developed and adopted a complete suite of **Standing Operating Procedures (SOPs)**, **financial policies**, **safety plans**, **administrative procedures**, **volunteer management tools**, and **operational policies**. Together, these documents ensure consistency, legal compliance, and institutional memory, no matter who serves on the Executive or volunteers in key roles.
...
| **Conflict of Interest Policy** | Establish disclosure and recusal requirements for all members and volunteers, not just directors. | – Definitions of conflicts.<br>– Disclosure process.<br>– Recusal procedures.<br>– Consequences for non‑disclosure. | Complements Bylaws Article XVII and Director Agreement. |
| **Donation, Sponsorship & Fundraising Policy** | Provide criteria for accepting donations, sponsorships, and grants, including ethical considerations. | – Acceptance criteria.<br>– Donor recognition guidelines.<br>– Ethical exclusions (e.g., tobacco, alcohol, political).<br>– Conflict disclosure. | Supports SaveTheMarina Squad fundraising efforts. |
| **Landscaping & Docks Construction Policy** | Establish rules for grounds maintenance, landscaping, and dock modifications to ensure consistent appearance and safety. | – Approved landscaping materials.<br>– Dock modification review process.<br>– Maintenance responsibilities.<br>– Environmental considerations. | Implied by Bylaws Article IX (Property Management). |
| **Sites Restricted to Transient (Short‑Term) Use Only** | Designate specific areas for temporary use to protect permanent member spaces and ensure fair access. | – Guest moorage areas.<br>– Short‑term parking zones.<br>– Time limits.<br>– Enforcement. | Complements Code of Conduct facility regulations. |
| **Meeting Procedures Quick Reference Guide** | Provide a concise guide to running orderly meetings (motions, voting, etc.) for board and general meetings. | – Motion types and language.<br>– Voting procedures.<br>– Role of the chair.<br>– Meeting etiquette. | Supports Bylaws Article IV (Meetings). |
| **Executive & Nomination Protocol** | Detail the process for nominating candidates and running board elections. | – Nomination deadlines.<br>– Eligibility requirements.<br>– Campaign guidelines.<br>– Election procedures. | Implements Bylaws Article XI (Election of Directors). |
| **Activity Proposal & Execution Template** | Provide a standardized form for proposing social events, fundraisers, and member activities. | – Event description.<br>– Resource requirements.<br>– Safety considerations.<br>– Approval process. | Required by Bylaws Article XV (Volunteer Squads). |
| **Project Proposal Template** | Provide a standardized form for capital improvements, major repairs, and infrastructure projects. | – Project scope and justification.<br>– Cost estimates.<br>– Timeline.<br>– Approval process. | Required by Bylaws Article X (Capital Projects). |
...
| **Well‑Run Events:** Alcohol Service Guidelines and Activity Templates make social gatherings safer and more enjoyable. | **Empowered Volunteers:** Clear position descriptions attract the right people and set them up for success. |
| **Transparent Governance:** Conflict of Interest Policy ensures fairness in all decisions. | **Strategic Direction:** Donation and Fundraising policies enable sustainable growth. |
...
graph TD
    ...
    subgraph Operational Policies
        ...
        Donation["🎁 DONATION & FUNDRAISING"]
        Landscaping["🌿 LANDSCAPING & DOCKS"]
        Transient["🚗 TRANSIENT USE SITES"]
        MeetingGuide["📋 MEETING PROCEDURES"]
    end

    subgraph Templates & Protocols
        Activity["📅 ACTIVITY TEMPLATE"]
        Project["🏗️ PROJECT TEMPLATE"]
        Election["🗳️ EXECUTIVE & NOMINATION PROTOCOL"]
    end
    ...
    CodeOfConduct --> Access
    CodeOfConduct --> Transient
    ...
    classDef templates fill:#e6ffe6,stroke:#333,stroke-width:1px;
    
    class Charter,Bylaws,CodeOfConduct core;
    class SOPs,Reserves,Retention,Privacy,VolunteerPD,Emergency,Grievance,Access,Procurement,Expense,Waitlist,Insurance,Incident,Communication,Alcohol,Screening,Conflict,Donation,Landscaping,Transient,MeetingGuide operational;
    class Activity,Project,Election templates;